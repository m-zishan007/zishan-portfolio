    ...
    <div className="border-b border-neutral-900 pb-24">
        ...
        <motion.div 
            ...
            <motion.div 
                ...
                <RiJavaLine className="text-7xl text-blue-500"/>
            </motion.div>
            <motion.div
        ...
        <motion.div
            ...
            <motion.div 
                ...
                animate="animate"
                className="rounded-2xl border-4 border-neutral-800 p-4">
                <SiApachekafka className="text-7xl text-blue-500"/>
            </motion.div>
            <motion.div
                variants={iconVariants(3)}
                initial="initial"
            ...
            <motion.div 
                ...
                animate="animate" 
                className="rounded-2xl border-4 border-neutral-800 p-4">
                <DiDocker className="text-7xl text-red-700"/>
            </motion.div>
            <motion.div
                ...
                animate="animate" 
                className="rounded-2xl border-4 border-neutral-800 p-4">
                <DiJenkins className="text-7xl text-cyan-400"/>
            </motion.div>
            <motion.div 
                variants={iconVariants(2.5)}
                initial="initial"
                animate="animate"
                className="rounded-2xl border-4 border-neutral-800 p-4">
                <DiLinux className="text-7xl text-blue-400"/>
            </motion.div>
        </motion.div>
    </div>
  );
